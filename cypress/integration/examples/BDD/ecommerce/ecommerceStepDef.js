...
When('I login to the application', function() {
    ...
    this.productPage.getCardLimit().should('have.length', 4)
...
When('validate the total price limit', function() {
 this.cartPage.checkTotalPriceInCart().then(function(sum) {
...
const confirmationPage= this.cartPage.clickonCheckOutBtn()
